    ...
    <div className="space-y-1">
      ...
      >
        <div className="flex items-center gap-3">
          <Blocks className={`w-4 h-4 ${isActive ? 'text-blue-600' : 'text-zinc-500'}`} />
      ...
      {isOpen && (
        <div className="pl-10 pr-3 py-1 space-y-1">
          <Link 
            ...
            className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-zinc-600 hover:text-orange-600 hover:bg-orange-50 rounded-md transition-colors"
          >
          ...
          <Link 
            ...
            className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-zinc-600 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors"
          >
